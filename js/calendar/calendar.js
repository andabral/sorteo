...
if (jscalendarDom){
	for	(i=0;i<jscalendarImgsrc.length;i++)
 	...
 	document.write ("  <link rel='stylesheet' type='text/css' href='"+rutacalimg+"js/calendar/calendar.css' media='all' ><div onclick='jscalendarBShow=true' id='calendar'	class='"+jscalendarThemePrefix+"-div-style'><table	style=font-size:1;width:"+((jscalendarShowWeekNumber==1)?250:220)+" class='"+jscalendarThemePrefix+"-table-style'><tr class='"+jscalendarThemePrefix+"-title-background-style'><td><table style='width:'"+((jscalendarShowWeekNumber==1)?248:218)+"'><tr><td class='"+jscalendarThemePrefix+"-title-style'><span id='caption'></span></td><td align=right><a href='javascript:jscalendarHideCalendar()'><span id='jscalendarCloseButton'></span></a></td></tr></table></td></tr><tr><td class='"+jscalendarThemePrefix+"-body-style'><span id='popupcalendar_content'></span></td></tr>")
...
function jscalendarConstructMonth(){
	...
	if (!jscalendarMonthConstructed) {
		...
		document.getElementById("selectMonth").innerHTML = "<table  style='width:70' class='"+jscalendarThemePrefix+"-dropdown-style'  cellspacing=0 onmouseover='clearTimeout(jscalendarTimeoutID1)'	onmouseout='clearTimeout(jscalendarTimeoutID1);jscalendarTimeoutID1=setTimeout(\"jscalendarPopDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>";
...
function jscalendarConstructYear() {
	...
	if (!jscalendarYearConstructed) {
		...
		document.getElementById("selectYear").innerHTML	= "<table style='width:44'; class='"+jscalendarThemePrefix+"-dropdown-style' onmouseover='clearTimeout(jscalendarTimeoutID2)' onmouseout='clearTimeout(jscalendarTimeoutID2);jscalendarTimeoutID2=setTimeout(\"jscalendarPopDownYear()\",100)' cellspacing='0'>"+sHTML+"</table>";
...
function jscalendarConstructCalendar ( ) {
	...
	var sHTML = "<table border=0 style='class:"+jscalendarThemePrefix+"-body-style'><tr>"

	if (jscalendarShowWeekNumber==1)
		sHTML += "<td style='width:27'><b>" + jscalendarWeekString + "</b></td><td style='width:1;class:'"+jscalendarThemePrefix+"-weeknumber-div-style' rowspan=7><img src='"+jscalendarImgDir+"divider.gif' style='width:1'></td>";

	for	(i=0; i<7; i++)
		sHTML += "<td style='width:27' align='right'><B>"+ jscalendarDayName[i]+"</B></td>";
