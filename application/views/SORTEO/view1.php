    ...
    <script type="text/javascript">
        ...
        function generartbequipos(){
        	v=validarnequipos();
        	if(v){
        		var nequipos=document.getElementById("nequipos");
                var data="nequipos="+nequipos.value;
                var xhr=getXMLHTTPRequest();
                var direccion = '<?php echo site_url('sorteo/formartbequipos'); ?>';
    	...
    	<div class="panel-heading" style="padding-left:0;padding-right: 0;">
            ...
            ?>
                <!--form id="formce" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $action; ?>" method="post"-->
                    ...
                    <fieldset style="margin-bottom: 16px; padding-top: 20px; border-top: 1px solid black; border-bottom: 1px solid black;">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" style="padding-top: 0" for="formGroupInputLarge">Numero de equipos:</label>
                        <div class="col-sm-4">
                            <input class="form-control" onchange="" autocomplete="off"  onkeypress="return check_onlyNumber(event);" type="text" id="nequipos" maxlength="10" name="nequipos" />
                        <span class="cobligatorio">*</span>
                        <div class="divlabelerr"><label id="elnequipos" class="lblmjerror2" style="display: none;"></label></div>
                        </div>
                        <div class="col-sm-2">
                            <!--input id="btnsaveform" class="btn btn-primary btn-lg" onclick="generartbequipos();" type="button" value="Generar campos"/-->
                        </div>
                    </div>
                    </fieldset>
                    <div id="divtbequipos">
                    ...
                    <div class="divrinp">
                      <input id="btnsaveform" class="btn btn-primary btn-lg" onclick="guardarform();" type="button" value="ENVIAR"/>
                      <!--input id="btnsaveform" class="btn btn-danger btn-lg" onclick=" document.location = '<?php echo site_url("sorteo")?>'" type="button" value="CANCELAR"/-->
                    </div>
    			</form>
    		<hr/>
